-- AlterTable
ALTER TABLE "quotes" ADD COLUMN     "tireSetId" TEXT;

-- AlterTable
ALTER TABLE "service_records" ADD COLUMN     "tireSetId" TEXT;
...
-- AddForeignKey
ALTER TABLE "service_records" ADD CONSTRAINT "service_records_tireSetId_fkey" FOREIGN KEY ("tireSetId") REFERENCES "tire_sets"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "quotes" ADD CONSTRAINT "quotes_tireSetId_fkey" FOREIGN KEY ("tireSetId") REFERENCES "tire_sets"("id") ON DELETE SET NULL ON UPDATE CASCADE;
