...
const strictPrefixes: { prefix: string; limit: number; windowMs: number }[] = [
  { prefix: "/api/v1/auth/sign-in", limit: 10, windowMs: 60_000 },
  { prefix: "/api/v1/auth/two-factor/verify", limit: 10, windowMs: 60_000 },
  { prefix: "/api/v1/auth/sign-up", limit: 5, windowMs: 60_000 },
  { prefix: "/api/v1/auth/request-password-reset", limit: 5, windowMs: 60_000 },
  { prefix: "/api/v1/auth/reset-password", limit: 5, windowMs: 60_000 },
];
