...
export const SMS_TEMPLATE_DEFAULTS: Record<string, string> = {
  [SETTING_KEYS.SMS_TEMPLATE_INVOICE_READY]: 'Your invoice is ready. View it here: {share_link}',
  ...
  [SETTING_KEYS.SMS_TEMPLATE_STATUS_READY]: 'Your vehicle is ready for pickup!',
