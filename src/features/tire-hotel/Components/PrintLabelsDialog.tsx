 ...
 * format is remembered per browser and the dialog opens ready to print. The
 * copy count starts at one per tire, which is the answer almost every time.
 *
 * Opens the PDF in a new tab rather than downloading it: on a roll printer
 * the next action is the browser print dialog, and a file in the downloads
 * folder is a detour.
 */
