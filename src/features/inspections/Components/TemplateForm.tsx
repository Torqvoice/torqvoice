        ...
        <div id={panelId} className="bg-muted/30 space-y-4 border-t px-3 py-4">
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-1.5">
              ...
              <p className="text-muted-foreground text-xs">{t(`inputHint.${item.inputType}`)}</p>
            </div>
          ...
          {isMeasurement && (
            <fieldset className="space-y-3">
              ...
              <p className="text-muted-foreground text-xs">{t('rangeHelp')}</p>
            </fieldset>
          )}
          ...
          <div className="space-y-1.5">
            ...
            />
            <p className="text-muted-foreground text-xs">{t('commonWordingHelp')}</p>
          </div>
  ...
  return (
    ...
    >
      <header className="flex items-start gap-1.5 border-b p-3">
        <DragHandle
          label={t('reorderSection', { name: section.name || String(index + 1) })}
          {...handleProps}
        />
    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      ...
      >
        <SheetHeader className="border-b px-6 py-4">
          ...
          <SheetDescription id="template-builder-description">{t('description')}</SheetDescription>
        </SheetHeader>
          ...
          <div className="grid min-h-0 flex-1 lg:grid-cols-[20rem_1fr]">
            ...
            <div className="space-y-5 overflow-y-auto border-b p-6 lg:border-r lg:border-b-0">
              ...
              <fieldset className="space-y-2">
                ...
                <p className="text-muted-foreground text-xs">
                  {severityScale === 'eu' ? t('scaleEuHelp') : t('scaleBasicHelp')}
                </p>
              </fieldset>
              ...
              <div className="flex items-start gap-2 rounded-lg border p-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-xs">{t('defaultHelp')}</p>
                </div>
              </div>
              ...
              <div className="space-y-3 border-t pt-4">
                ...
                <p className="text-muted-foreground text-xs">
                  {t('renumberHelp')}
                  {hasRegulationCodes && (
                    <strong className="text-foreground block pt-1">{t('renumberWarning')}</strong>
                  )}
                </p>
              </div>
            </div>
            ...
            <div className="bg-muted/20 min-h-0 overflow-y-auto p-6">
                  ...
                  <div className="space-y-4">
                    {sections.map((section, index) => (
                      <SectionCard
                        ...
                        onDelete={() => setSections((prev) => prev.filter((_, i) => i !== index))}
                        onAddItem={() =>
                          patchSection(index, {
                            items: [
                              ...section.items,
              ...
              <Button
                ...
                onClick={() =>
                  setSections((prev) => [...prev, blankSection(nextSectionCode(prev))])
                }
              >
