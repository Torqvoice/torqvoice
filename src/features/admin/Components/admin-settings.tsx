...
export function AdminSettings({
  ...
  const [sesRegion, setSesRegion] = useState(initial[SYSTEM_SETTING_KEYS.SES_REGION] || 'us-east-1')
  const [sesFromEmail, setSesFromEmail] = useState(
    initial[SYSTEM_SETTING_KEYS.SES_FROM_EMAIL] || ''
  )
  const [sesFromName, setSesFromName] = useState(initial[SYSTEM_SETTING_KEYS.SES_FROM_NAME] || '')
  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-0.5">
            <Label htmlFor="email-verification-toggle">
              {t('adminSettings.requireEmailVerification')}
            </Label>
            <p className="text-xs text-muted-foreground">
      ...
      >
        ...
        {emailProvider === 'resend' && (
          <>
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-muted-foreground">{t('adminSettings.resendApiKeyHint')}</p>
            </div>
        ...
        {emailProvider === 'ses' && (
          <>
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-muted-foreground">{t('adminSettings.awsRegionHint')}</p>
            </div>
        ...
        <div className="flex items-center gap-2 pt-2">
          ...
          <p className="text-xs text-muted-foreground">{t('adminSettings.testEmailHint')}</p>
        </div>
      </AppCard>
