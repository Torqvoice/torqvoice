      ...
      <DialogContent className="sm:max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            />
            {/* modal: the list portals out of this dialog, and the dialog's
                scroll lock would otherwise swallow wheel events over it. */}
            <Popover open={vehicleOpen} onOpenChange={setVehicleOpen} modal>
                    ...
                    <CommandGroup>
                      ...
                      >
                        <Check
                          className={cn(
                            'mr-2 h-4 w-4',
                            !formVehicleId ? 'opacity-100' : 'opacity-0'
                          )}
                        />
                        {t('noneOption')}
                      </CommandItem>
