...
/**
 * Every line on one numbered list, the way a workshop that quotes a job as a
 * single sequence of positions expects to see it, rather than split across a
 * parts table and a labor table.
 */
export function ItemsTable({
  ...
  return (
    <View>
      <Text style={styles.sectionTitle}>{labels.items || 'Items'}</Text>
